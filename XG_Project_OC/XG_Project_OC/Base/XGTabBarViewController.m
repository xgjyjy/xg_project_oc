...
- (void)configTabberControllers {
    self.viewControllers = @[[self chiledViewControllerWithTabBarTitle:@"首页"
                                                        barNormalImage:@"tab_home_normal"
                                                      barSelectedImage:@"tab_home_selected"
                                                       rootVcClassName:@"XGHomeViewController"],
                             [self chiledViewControllerWithTabBarTitle:@"消息"
                                                        barNormalImage:@"tab_information_normal"
                                                      barSelectedImage:@"tab_information_selected"
                                                       rootVcClassName:@"XGMessageViewController"],
                             [self chiledViewControllerWithTabBarTitle:@"设置"
                                                        barNormalImage:@"tab_my_normal"
                                                      barSelectedImage:@"tab_my_selected"
                                                       rootVcClassName:@"XGSettingViewController"]];
}
...
- (XGNavigationController *)chiledViewControllerWithTabBarTitle:(NSString *)title
                                               ...
                                               barSelectedImage:(NSString *)selectedImage
                                                rootVcClassName:(NSString *)className {
    ...
    if (@available(iOS 13.0, *)) {
        ...
        normalAttributes[NSForegroundColorAttributeName] = [UIColor xg_colorWithHexString:@"939393"];
        tabBarAppearance.stackedLayoutAppearance.normal.titleTextAttributes = normalAttributes.copy;
        
        self.tabBar.standardAppearance = tabBarAppearance;
    } else {
        [vc.tabBarItem setTitleTextAttributes:@{NSForegroundColorAttributeName : [UIColor xg_colorWithHexString:@"939393"]} forState:UIControlStateNormal];
